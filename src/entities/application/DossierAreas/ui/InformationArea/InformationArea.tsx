  ...
  const getAdditionalOptionsInfo = useCallback((additionalOptions: AdditionalOptions[]) => {
    ...
    for (const additionalOption of additionalOptions) {
      additionalOptionsInfo.push(
        { value: additionalOption.productType, gridColumn: 2 },
        { value: additionalOption.productCost + ' руб.', gridColumn: 1 },
        { value: additionalOption.isCredit ? 'В кредит' : 'Не в кредит', gridColumn: 4 },
      )
    }
