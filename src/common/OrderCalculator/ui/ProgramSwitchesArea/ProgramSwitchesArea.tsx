...
import { useIsHasCarWithGovProgram } from 'common/OrderCalculator/hooks/useIsHasCarWithGovProgram'
...
export function ProgramSwitchesArea() {
  ...
  const { isHasCarWithGovProgram } = useIsHasCarWithGovProgram()
  ...
  if (!isHasCarWithGovProgram && !isGovernmentProgram && !isDfoProgram) {
    return null
  }
