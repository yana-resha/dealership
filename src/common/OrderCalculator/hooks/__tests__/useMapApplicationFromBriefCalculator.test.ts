...
import { useMapApplicationFromBriefCalculator } from '../useMapApplicationFromBriefCalculator'
...
import { EXPECTED_REMAPPED_BRIEF_DATA } from './useMapApplicationFromBriefCalculator.mock'
...
describe('useMapApplicationFromBriefCalculator', () => {
  beforeEach(() => {
